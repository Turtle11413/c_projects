...
void make_new_coord(int *coord_player1, int *coord_player2);
...
int main() {
    ...
    while ((count_points_of_player1 != GAME_END) && (count_points_of_player2 != GAME_END)) {
        ...
        make_new_coord(&player1y, &player2y);
...
void make_new_coord(int *coord_player1, int *coord_player2) {
    ...
    switch (inp) {
        case 'a':
        case 'A':
            if (*coord_player1 > 2) *coord_player1 -= 1;
            break;
        case 'z':
        case 'Z':
            if (*coord_player1 < FIELD_HEIGHT - 3) *coord_player1 += 1;
            break;
        case 'K':
        case 'k':
            if (*coord_player2 > 2) *coord_player2 -= 1;
            break;
        case 'm':
        case 'M':
            if (*coord_player2 < FIELD_HEIGHT - 3) *coord_player2 += 1;
            break;
    }
}
